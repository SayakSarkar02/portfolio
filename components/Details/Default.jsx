...
const Default = () => {
  ...
  return (
    ...
    <span className="sm:hidden pb-40 text-justify">
      <br />
      As a <span className="text-vs-blue-2 text-justify">full-stack web developer</span> and <span className="text-vs-blue-2 text-justify"> graphic designer </span> , I bring together technical expertise and creativity. I love crafting captivating user experiences and visually stunning designs. I am a national award winner in poster design. I'm always seeking opportunities to learn and grow in the ever-changing world of technology. Let's make a positive impact together!
    </span>
  </div>
  )
}
